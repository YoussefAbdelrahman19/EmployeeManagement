...
<div class="card-body">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ old('Last Name',$user->last_name) }}" required autocomplete="last_name" autofocus>
...
<button class="btn btn-danger" type="submit" >Delete {{$user->username}}</button>
            ...
            {{--  Outer content for change password --}}
